    ...
    <div style={{fontFamily:'system-ui,sans-serif',background:dark,color:white,minHeight:'100vh',padding:'40px 24px'}}>
      <div style={{maxWidth:800,margin:'0 auto'}}>
        ...
        {[
          ...
          ['7. Privacy Policy','Your data is stored securely and used solely for the purpose of connecting you with relevant service providers. We do not sell your Social Security Number, bank account numbers, or passwords. See our full Privacy Policy at workbridge-rho.vercel.app/privacy.'],
