  ...
  const plans = [
    {
      ...
      color: A,
      features: [
        'Unlimited Coach Ray access',
        'All 10 missions (jobs, housing, education, veteran, debt, and more)',
        'GED tutoring with mock tests and study plans',
        'Personalized job matching by ZIP code',
        'SMS alerts when employers respond',
        'Document generation (resumes, cover letters, plans)',
        'Bilingual EN/ES support',
        'Credit repair and business startup guidance'
      ],
    ...
    },
    {
      ...
      popular: true,
      features: [
        'Access pre-qualified candidate pool',
        'Filter candidates by skill, ZIP, availability',
        'Direct SMS messaging to candidates ($0.10/msg)',
        'Coach Ray appointment setting',
        'Candidate tracking dashboard',
        'Mark hired + outcome reporting',
        'Pay-per-lead for premium qualified candidates',
    ...
    },
    {
      ...
      features: [
        ...
        'Case manager portal with outcome tracking',
        'Unlimited client onboarding',
        'Coach Ray powered by your organization name',
        'Custom missions for your programs',
  ...
  return (
    <main style={{minHeight:'100vh',background:BG,color:W,padding:'40px 16px'}}>
      <div style={{maxWidth:1000,margin:'0 auto',textAlign:'center'}}>
        ...
        <p style={{color:'rgba(240,244,248,.5)',fontSize:16,marginBottom:40,maxWidth:500,margin:'0 auto 40px'}}>
          Whether you're looking for work or looking for workers — WorkBridge connects you faster than any job board.
        </p>

        <div style={{display:'flex',gap:20,justifyContent:'center',flexWrap:'wrap'}}>
          {plans.map((p,i)=>(
            <div key={i} style={{flex:1,minWidth:280,maxWidth:320,padding:'28px 24px',background:'rgba(255,255,255,.03)',
              border:`1px solid ${p.popular?p.color+'60':'rgba(255,255,255,.08)'}`,borderRadius:16,textAlign:'left',
              position:'relative'}}>
